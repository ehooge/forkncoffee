...
Marseille 2012, avec trois personnes nous lancions Workncoffee, via un wordpress cheap <https://marseilleworkncoffee.wordpress.com>, basé sur la une volonté d''exaptation du travail. L'exaptation est une adaptation sélective opportuniste, privilégiant des caractères qui sont utiles à une nouvelle fonction, pour laquelle ils n'avaient pas été initialement sélectionnés. Par exemple, lors d'une baisse de la quantité d’oxygène dans l'eau des lagunes au corbonifère, les tétropodes se sont mis à utiliser un sac repsiratoire (ancêtre des poumons) pour s'adapter à la vie terrestre et la repsiration aérienne. Un organe qui n'était auparavant pas utilisé lors de leur vie en milieu auqatique.
...
Pour faire plus simple, nous cherchions à concevoir des circonstances de rencontres de rencontres entre individus de sphères professionnelles différentes, nous voulions faire tiers-lieux libres presque n'importe où, nous visions les qualités de nos conditions de travail. Cafés de quartiers, plages, salle associative, appartement, studio d'enregistrement... Nous avons testé de nombreux spots de coworking qui à l'époque semblaient « insolites » pour beaucoup de monde. Cela nous à coûté moins cher que les bureaux partagés co-working business de l'époque à Marseille ; cela à permis des rencontres avec des marins-pêcheurs ; cela été fait avec plus de libertés et de conforts que ne le permettaient les espaces auto-proclamés co-working.
...
+ Des blogs et un site internet avec documentation peuvent préfigurer une esquisse de structure de focntionnement = **Framework**
+ Les cartes que nous faisons avec les histoires qui les accompagnent sont strates géographiques et sociologiques = **Layer**

De 2013 à 2018 j'ai participé à divers projets concernant les mutations du travail et les ogranisations novatrices, soit comme contributeur, soit comme fondateur-contributeur.

### Démarches liées et projets connectés

Ces démarches et projets nourrissent les réflexions sur les problématiques auxquelles forkncoffee tente de répondre, ils permettent également des apports méthodologiques, techniques et technologiques au projet.
...
+ [multbao.org + repo nomades](http://www.multibao.org), la boîte-à-outils des organisations collaboratives - [contributeur et mianteneur](https://github.com/orgs/multibao/teams/gestionnaires/members).
...
+ [LabOSe 2016](https://paper.dropbox.com/doc/LabOSe-Laboratoire-open-source-dexperiences-libres-et-distribuees-KwBdA6CpH17tiqPcCgmfW), laboratoire intinérant des pratiques collaboratives dans les Communs - fondatuer-contributeur
...
Github est racheté par Microsoft, ce qui inquiète 95% du code source des logiciels libres puisqu'ils sont présent sur la plateforme github qui était déjà avant son rachat une entreprise de droit privé ; et Microsoft était déjà le plus gros contributeur à github. C'est la concentration qui est dangereuse dans ce processus. Apparaît alors les question de migrer vers vers Gitlab.org : savez-vous que Google est en fait un énorme investisseur dans Gitlab entreprise de droit privé ?
...
Les coworking et tiers-lieux libres et open source ont leur portail informationnel, <http://movilab.org>, qui contient recettes, retour d'expériences, documentation de processus et configuration sociale, de nombreuses données. Mais ce portail ne favorise pas les conditions de rencontre pour faire tiers-lieux presque n'importe où. Il s'agit bien de "faire tiers-lieux" et non de limiter cette configuration sociale particulière à responsabilités partagées à des espaces délimités par quatre murs et un toit, et encore mois à des frontières administratives.

Il y a des centaines d'intiatives d'agrégation des tiers-lieux, mais rien de décentralisé ni fédéré, parfois même avec des sytèmes non-libres. 

Alors, comment aller vers des « espaces ouverts et partagés » [Simon Sarazin] ? Nous avons besoins de favoriser des cultures libres et de la compostabilité d'un écosystème.
...
Nous n'avons pas encore franchi le passage vers une proposition d'ossature (framework) facilitant l'acquisition par l'expérience vécue des briques culturelles, intellectuelles, technologiques, afin de déployer de façon distribuée les conditions et circonstances de rencontres, afin de laisser émerger des situations brisant les silos et concentrations en fournissant une décentralisation fédérée. 


### Visions

Essayons de faire de forkncoffee une des étapes vers ces ossatures avec un prototype sous licence dans le domaine public, avec des documentations, bloggings, cartes géographiques et jeux de données, distribués, décentralisés et fédérés.

Forkncoffee est projet pour les rassembler et gouverner tous ? Non ! Car conçu pour être basé sur un principe de fédération (voir [backlog](https://github.com/XavCC/forkncoffee/projects/1).

Des cartes géographiques ? Non ! Des paysages de données commentées par celles et ceux qui les font et non limitées à des frontières administratives ; et surtout des cartes, et non une carte, avec des bordures qui peuvent se chevaucher pour rendre visibles les interconnexion entre les communautés de pratiques. 
...
Tout en apprenant et en concevant un prototype technologique partagé et documenté au jour le jour, il est important d'essayer d'apporter les conditions nouvelles pour répondre aux problèmes décrits précédemment. Il s'agit de prototyper en itération permanente, de sortir des cartes de routes (roadmap) pour tenter un fonctionnement en chaos (chaos map), de collaborer au mieux, à plusieurs, et de documenter les techniques, méthologies et technologies en temps quasi-instantané. 
...
Forkncoffee est démarré au 1er juin 2018, la sortie prévue est 10 septembre 2018. 3 mois de travail sérieux et appliqué ainsi qu'un livre nuémrique alimenté pas à pas sur l'expérience d'apprentissage et de partage du langage elm et du porjet fokncoffee.

C'est un temps délibérément choisi pour faciliter le compréhension et l'intégration des concepts en langage elm, c'est un temps permettant une démarche itérative non-linéaire d'apprentissage et de partage.

Je souhaite inscrire cela dans une carte chaotique (choas map) par opposition à une carte de route (raodmap) standarisée afin de tester et de documenter cette expérience d'apprentissage par le faire, ce qui ne rentre pas dans les formats habituels de cahiers des charges. Ceci sera notamment matérialisé par l'écriture d'un livre numérique sous licence libre. 
...
J'ai donc pris le parti de proposer de financer ce projet fokncoffee par une campagne de dons libres provenant de personnes trouvant un intérêt à cette démarche. Au-delà de l'aspect projet et temps de développement web de la première version du prototype forkncoffee, je propose également d'alimenter le plus régulièrement possible un livre numérique, également sous licence libre, afin de fournir les traces documentées d'un processus chaotique d'apprentissage du langage elm au travers des avancées de ce projet. C'est le concept du « Apprendre en faisant, apprendre en partageant ». Ces efforts sont fournis pour partager un maximum de savoirs libres, savoir-faire et savoir-être, ainsi qu'à favoriser l'approriation et la réutilisation des processus qui mènent à un prototype. Ce livre est intitulé « [Elm : apprendre par le chaos d'un prototype](https://xavcc.gitbooks.io/elm-chaos/content) »
